...
const Header = () => {
  ...
  return (
    <div className='absolute top-0 left-0 right-0 bg-gradient-to-r from-gray-900 via-black to-gray-900 backdrop-blur-md border-b border-gray-800 z-50 px-6 py-4 flex justify-between items-center shadow-lg'>
